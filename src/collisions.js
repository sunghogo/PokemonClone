...
import { collisionsMap } from './data-handling/data.js';
...
// Calculates collision between player and collision objects
function detectPlayerCollision({ offsetX = 0, offsetY = 0 }) {
